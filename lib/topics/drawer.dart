...
import 'package:privacyapp/quiz/quiz.dart';
...
class QuizBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //print(topic.id);
    //print(Report.topics['vpn']);
    var completed = Report.topics[topic.id] ?? [];
    // var completed = Report.topics[topic.id] ?? [];
    //List completed_list =List.from(completed);
    //print(completed_list.runtimeType);
